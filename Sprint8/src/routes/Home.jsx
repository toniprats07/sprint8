    ...
    <>
      <div className="home-conatiner">
        <p className="home-text">
          Welcome to the website where you can discover the different ships that
          exist in the Star Wars universe! Here you can see images of the iconic
          ships from the saga, along with detailed information about their
          characteristics and abilities. May the Force be with you as you
          explore this exciting page!
        </p>
        <Link className="btn-home" to="/starships">
          <div className="icono">
            <svg
